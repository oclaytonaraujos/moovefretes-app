...
export const expoContextIntegration = () => {
    ...
    function captureEmergencyLaunchEvent(client) {
        if (!isExpo() || isExpoGo()) {
            return;
        }
    ...
    function addExpoUpdatesContext(event) {
        ...
        event.contexts[OTA_UPDATES_CONTEXT_KEY] = Object.assign({}, updatesContext);
...
function addExpoUpdatesTags(event, updatesContext) {
