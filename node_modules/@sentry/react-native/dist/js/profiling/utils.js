...
export function enrichCombinedProfileWithEventContext(profile_id, profile, event) {
    ...
    const { profilingStartTimestampNs } = profile, profileWithoutInternalFields = __rest(profile, ["profilingStartTimestampNs"]);
    return Object.assign(Object.assign({}, profileWithoutInternalFields), { event_id: profile_id, runtime: {
            name: 'hermes',
            ...
            : event.start_timestamp
                ...
                : new Date().toISOString(), release: event.release || '', environment: event.environment || getDefaultEnvironment(), os: {
...
export function enrichAndroidProfileWithEventContext(profile_id, profile, event) {
    ...
    const { profilingStartTimestampNs } = profile, profileWithoutInternalFields = __rest(profile, ["profilingStartTimestampNs"]);
    return Object.assign(Object.assign({}, profileWithoutInternalFields), { debug_meta: {
            ...
            : event.start_timestamp
                ? new Date(event.start_timestamp * 1000).toISOString()
                : new Date().toISOString(), release: event.release || '', dist: event.dist || '', transaction_id: event.event_id || '', transaction_name: event.transaction || '', trace_id: ((_q = (_p = event.contexts) === null || _p === void 0 ? void 0 : _p.trace) === null || _q === void 0 ? void 0 : _q.trace_id) || '', version_name: event.release || '', version_code: event.dist || '' });
}
/**
