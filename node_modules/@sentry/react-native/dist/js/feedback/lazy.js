 ...
 */
export function lazyLoadShakeToReportIntegration() {
    var _a, _b;
    const integration = (_a = getClient()) === null || _a === void 0 ? void 0 : _a.getIntegrationByName(SHAKE_TO_REPORT_INTEGRATION_NAME);
    if (!integration) {
        // Lazy load the integration to track usage
        (_b = getClient()) === null || _b === void 0 ? void 0 : _b.addIntegration({ name: SHAKE_TO_REPORT_INTEGRATION_NAME });
    }
}
