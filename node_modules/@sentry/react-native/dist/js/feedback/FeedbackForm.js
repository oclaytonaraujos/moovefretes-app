...
export class FeedbackForm extends React.Component {
    constructor(props) {
            ...
            if (!this._hasScreenshot()) {
                ...
                if (imagePicker) {
                    ...
                    if ((result === null || result === void 0 ? void 0 : result.assets) && result.assets.length > 0) {
                        if (isWeb()) {
                            const filename = (_a = result.assets[0]) === null || _a === void 0 ? void 0 : _a.fileName;
                            const imageUri = (_b = result.assets[0]) === null || _b === void 0 ? void 0 : _b.uri;
                            const base64 = (_c = result.assets[0]) === null || _c === void 0 ? void 0 : _c.base64;
                            ...
                            const filename = (_d = result.assets[0]) === null || _d === void 0 ? void 0 : _d.fileName;
                            const imageUri = (_e = result.assets[0]) === null || _e === void 0 ? void 0 : _e.uri;
                            imageUri &&
        ...
        this._saveFormState = () => {
            FeedbackForm._savedState = Object.assign({}, this.state);
        };
    ...
    render() {
        ...
        const styles = Object.keys(_defaultStyles).reduce((merged, key) => {
            merged[key] = Object.assign(Object.assign({}, _defaultStyles[key]), _propStyles[key]);
            return merged;
        }, {});
        const onCancel = () => {
            if (onFormClose) {
        ...
        return (React.createElement(TouchableWithoutFeedback, { onPress: notWeb() ? Keyboard.dismiss : undefined, accessible: false, accessibilityElementsHidden: false },
            React.createElement(View, { style: styles.container },
                ...
                config.showName && (React.createElement(React.Fragment, null,
                    ...
                    React.createElement(TextInput, { style: styles.input, testID: "sentry-feedback-name-input", placeholder: text.namePlaceholder, value: name, onChangeText: value => this.setState({ name: value }), autoCorrect: false, spellCheck: false }))),
                config.showEmail && (React.createElement(React.Fragment, null,
                    React.createElement(Text, { style: styles.label },
                        text.emailLabel,
                        config.isEmailRequired && ` ${text.isRequiredLabel}`),
                    React.createElement(TextInput, { style: styles.input, testID: "sentry-feedback-email-input", placeholder: text.emailPlaceholder, keyboardType: 'email-address', autoCapitalize: "none", autoCorrect: false, spellCheck: false, value: email, onChangeText: value => this.setState({ email: value }) }))),
                React.createElement(Text, { style: styles.label },
                    text.messageLabel,
                    ` ${text.isRequiredLabel}`),
                React.createElement(TextInput, { style: [styles.input, styles.textArea], testID: "sentry-feedback-message-input", placeholder: text.messagePlaceholder, value: description, onChangeText: value => this.setState({ description: value }), multiline: true, autoCorrect: autoCorrect, spellCheck: spellCheck }),
...
FeedbackForm.defaultProps = defaultConfiguration;
FeedbackForm._savedState = {
    name: '',
    email: '',
    description: '',
