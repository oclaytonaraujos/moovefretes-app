...
export const feedbackIntegration = (initOptions = {}) => {
    const { buttonOptions, screenshotButtonOptions, colorScheme, themeLight: lightTheme, themeDark: darkTheme, enableShakeToReport: shakeToReport } = initOptions, widgetOptions = __rest(initOptions, ["buttonOptions", "screenshotButtonOptions", "colorScheme", "themeLight", "themeDark", "enableShakeToReport"]);
    return {
...
export const isShakeToReportEnabled = () => {
    var _a;
    const integration = _getClientIntegration();
    return (_a = integration === null || integration === void 0 ? void 0 : integration.enableShakeToReport) !== null && _a !== void 0 ? _a : false;
};
