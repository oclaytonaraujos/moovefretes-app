...
export const reactNavigationIntegration = ({ routeChangeTimeoutMs = 1000, enableTimeToInitialDisplay = false, ignoreEmptyBackNavigationTransactions = true, enableTimeToInitialDisplayForPreloadedRoutes = false, useDispatchedActionData = false, useFullPathsForNavigationRoutes = false, enablePrefetchTracking = false, } = {}) => {
    ...
    let latestNavigationSpanNameCustomized = false;
    ...
    const startIdleNavigationSpan = (unknownEvent, isAppRestart = false) => {
        ...
        const finalSpanOptions = (tracing === null || tracing === void 0 ? void 0 : tracing.options.beforeStartSpan)
            ? tracing.options.beforeStartSpan(spanOptions)
            : spanOptions;
        latestNavigationSpanNameCustomized = finalSpanOptions.name !== originalName;
        latestNavigationSpan = startGenericIdleNavigationSpan(finalSpanOptions, Object.assign(Object.assign({}, idleSpanOptions), { isAppRestart }));
        ...
        const spanName = (_a = finalSpanOptions.name) !== null && _a !== void 0 ? _a : DEFAULT_NAVIGATION_SPAN_NAME;
 ...
 */
function getRouteNameFromAction(event) {
    var _a, _b;
    const payload = (_b = (_a = event === null || event === void 0 ? void 0 : event.data) === null || _a === void 0 ? void 0 : _a.action) === null || _b === void 0 ? void 0 : _b.payload;
